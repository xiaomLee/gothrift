...
func (p *FormatDataClient) Ping(ctx context.Context) (r string, err error) {
  var _args2 FormatDataPingArgs
  var _result3 FormatDataPingResult
...
func NewFormatDataProcessor(handler FormatData) *FormatDataProcessor {
  ...
  self4.processorMap["ping"] = &formatDataProcessorPing{handler:handler}
return self4
}
...
type formatDataProcessorPing struct {
  handler FormatData
}

func (p *formatDataProcessorPing) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := FormatDataPingArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
type FormatDataPingArgs struct {
}

func NewFormatDataPingArgs() *FormatDataPingArgs {
  return &FormatDataPingArgs{}
}

func (p *FormatDataPingArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *FormatDataPingArgs) Write(oprot thrift.TProtocol) error {
...
func (p *FormatDataPingArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("FormatDataPingArgs(%+v)", *p)
}

// Attributes:
//  - Success
type FormatDataPingResult struct {
  Success *string `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewFormatDataPingResult() *FormatDataPingResult {
  return &FormatDataPingResult{}
}

var FormatDataPingResult_Success_DEFAULT string
func (p *FormatDataPingResult) GetSuccess() string {
  if !p.IsSetSuccess() {
    return FormatDataPingResult_Success_DEFAULT
  }
return *p.Success
}
func (p *FormatDataPingResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *FormatDataPingResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *FormatDataPingResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *FormatDataPingResult) Write(oprot thrift.TProtocol) error {
...
func (p *FormatDataPingResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
...
func (p *FormatDataPingResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("FormatDataPingResult(%+v)", *p)
}
